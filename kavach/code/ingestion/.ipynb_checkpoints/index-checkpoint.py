...
def get_keywords(page_md: str, qa: str, page_image_path: str, page: str):
    img = Part.from_image(Image.load_from_file(page_image_path))

    response_dict = generate(keyword_prompt, ["input:\n", page_md, qa, img])
    keywords = []
    ...
    if response_dict["code"] == 200:
        ...
        logger.warning("Error in getting the keywords for {page}")
...
def get_qa(page_md: str, page_image_path: str, page: str):
    ...
    response_dict = generate(qa_prompt, ["input:\n", page_md, img])
...
def make_docs(processed_folder: str):
    docs = []
